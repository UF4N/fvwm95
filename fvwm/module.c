			...
			int *Module)
{
  ...
  if(*Module >= 0)
	...
	SendPacket(*Module,M_FOCUS_CHANGE,5,Scr.Hilite->w,Scr.Hilite->frame,
		   (unsigned long)Scr.Hilite,Scr.ActiveTitleColors.fore,
		   Scr.ActiveTitleColors.back,0,0);
      else
	SendPacket(*Module,M_FOCUS_CHANGE,5,0,0,0,Scr.ActiveTitleColors.fore,
		   Scr.ActiveTitleColors.back,0,0);
      ...
      else 
	{
	  Broadcast(M_FOCUS_CHANGE,5,Scr.Hilite->w,
		    ...
		    Scr.ActiveTitleColors.fore,Scr.ActiveTitleColors.back,0,0);
	}
